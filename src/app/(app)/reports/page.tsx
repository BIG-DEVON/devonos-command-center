...
import { BarChart3, Crown, FileText, Sparkles } from "lucide-react";
        ...
        <div className="mb-6 grid gap-4 xl:grid-cols-[1.35fr_0.65fr]">
          <div className="devon-glass devon-card-shine rounded-[2.6rem] p-6 md:p-8">
            ...
            <div className="mt-8 grid gap-3 md:grid-cols-3">
              ...
              <div className="rounded-[1.55rem] border border-slate-950/[0.08] bg-white/62 p-4 shadow-[0_14px_40px_rgba(15,23,42,0.04)]">
                <p className="text-sm font-medium text-slate-400">Analyze</p>
                <p className="mt-2 text-xl font-semibold tracking-tight text-[#0B0D12]">
                  Progress signals
                </p>
              </div>
              ...
              <div className="rounded-[1.55rem] border border-slate-950/[0.08] bg-white/62 p-4 shadow-[0_14px_40px_rgba(15,23,42,0.04)]">
                <p className="text-sm font-medium text-slate-400">Copy</p>
                <p className="mt-2 text-xl font-semibold tracking-tight text-[#0B0D12]">
                  Ready reports
                </p>
              </div>
          ...
          <div className="devon-glass-dark devon-ink-shine rounded-[2.6rem] p-6 text-white">
            ...
            <h2 className="mt-4 text-2xl font-semibold tracking-tight">
              One report from every module.
            </h2>

            <p className="mt-3 text-sm leading-6 text-white/52">
              DevonOS reads your saved browser data for now. Later, reports will
              come from the database with charts, exports, and scheduled
              delivery.
            </p>
            ...
            <div className="mt-7 rounded-[1.4rem] border border-white/10 bg-white/[0.055] p-4">
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm font-medium text-white/68">
                  Copy-ready command brief generated instantly.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-[#8A6B22]/80">
                We’ll add PDF exports, charts, date filters, email delivery,
                advanced analytics, and AI-generated executive summaries after
                the backend layer is stable.
              </p>
            </div>
          </div>
        </div>
