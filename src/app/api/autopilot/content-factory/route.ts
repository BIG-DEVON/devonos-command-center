...
export async function POST() {
  try {
    ...
    for (const birthday of upcomingBirthdays) {
      ...
      await prisma.socialDraft.create({
        data: {
          ...
          hashtags: "#Birthday #Celebration #Morrow",
          notes: `Generated by Morrow Content Factory for ${birthdayDate}. Review before posting.`,
        },
      });
    ...
    for (const event of upcomingEvents) {
      ...
      await prisma.socialDraft.create({
        data: {
          ...
          hashtags: "#Awareness #Communications #Morrow",
          notes: `Generated by Morrow Content Factory from Global Events. Relevance: ${event.relevance}. Review before posting.`,
        },
      });
    ...
    for (const newsItem of highNewsItems) {
      ...
      await prisma.socialDraft.create({
        data: {
          ...
          notes:
            "Generated by Morrow Content Factory from a high-relevance news signal. Verify before use.",
        },
      });
    ...
    return NextResponse.json({
      ...
      message:
        created.length > 0
          ...
          : `No new social drafts were needed. Morrow skipped ${skipped.length} duplicate(s).`,
    });
  } catch (error) {
    ...
    return NextResponse.json(
      {
        ok: false,
        message: "Morrow Content Factory could not create drafts.",
      },
      { status: 500 }
    );
  }
